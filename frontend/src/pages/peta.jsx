...
export default function Peta() {
    ...
    getClusterData(year)
      .then(data => {
        const mergedData = data.data.map(item => {
          const coords = provinceCoords[item.province.toUpperCase()] || { lat: 0, lon: 0 };
          return {
            ...item,
            lat: coords.lat,
            lon: coords.lon,
            clusterColor: item.cluster === 1 ? "green" : item.cluster === 2 ? "red" : "gray"
          };
        });
  ...
  return (
    <div className="ipm-page">
      ...
      <main className="ipm-main-content" style={{ backgroundColor: "#64b5f6", minHeight: "100vh" }}>
